        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
              ...
              >
                <h2 className="font-display text-lg sm:text-4xl font-bold text-foreground mb-2">Featured Products</h2>
              ...
              <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                  <motion.div
                    ...
                    transition={{ duration: 0.6 }}
                  >
                    <h2 className="font-display text-lg sm:text-4xl font-bold text-foreground mb-2" data-testid={`heading-category-${categorySlug}`}>
                      {category.name}
                    </h2>
                    <div className="h-1.5 w-16 bg-secondary rounded-full" />
                  </motion.div>
